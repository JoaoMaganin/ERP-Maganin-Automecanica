...
const Dashboard = () => {
    ...
    return (
        <div>
            <h1 style={{ textAlign: "center" }}>Módulos do sistema</h1>
            <div className="grid">
                <div className="col-12 md:col-2">
                    <Link href="/pages/estoque">
                        <Button label="Estoque" icon="pi pi-box" className="w-full" />
                    </Link>
                </div>
                <div className="col-12 md:col-2">
                    <Link href="#">
                        <Button label="Em breve..." icon="pi pi-hourglass" className="w-full" disabled/>
                    </Link>
                </div>
                <div className="col-12 md:col-2">
                    <Link href="#">
